...
- **Machine Learning:** Regression, Classification, Clustering, Ensemble Models (Random Forest, XGBoost, AdaBoost)  
- **Deep Learning:** Neural Networks, CNNs, Transformers, LLMs, RAG  
